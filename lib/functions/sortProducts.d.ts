/**
   ...
   */
declare type BasicProduct = {
    name?: string;
    title?: string;
    price: number | string;
    [key: string]: any;
};
export default function (sortProperty: string, order: string, productArr: Array<BasicProduct>): void;
export {};
//# sourceMappingURL=sortProducts.d.ts.map